...
fun Anasayfa(navController: NavController){
    val filmlerListesi = remember {
        mutableStateListOf<Filmler>()
    }
    ...
    Scaffold(
        ...
        LazyVerticalGrid(
            ...
            columns = GridCells.Fixed(count = 2) //bir satırda kaç tane görüntüleyeceğini yazmak için
        ) {
            items(
                count = filmlerListesi.count(),
                itemContent = {//0,1,2,3,4,5
                    ...
                    Card(modifier = Modifier.padding(all = 5.dp)) {
                        Column(
                            ...
                            Image(bitmap = ImageBitmap.imageResource(id = activity.resources.getIdentifier(film.resim, "drawable", activity.packageName)),
